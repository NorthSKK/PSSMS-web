...
อ่านไม่ออกถ้าไม่บอก · เซลล์แสดง `%` เป็นตัวหลัก (กวาดตาเทียบครูหลายคน) เศษส่วนเป็นตัวรอง
(ดูตอนจะไปคุยกับเจ้าตัว) · `expected=0` ขึ้น `—` **ไม่ใช่ `0%`** — "ไม่มีให้ทำ" กับ "ยังไม่ได้ทำ"
คนละเรื่อง โฮมรูมจึงเป็น `—` ในคอลัมน์ตั้งค่าวิชาและคะแนน
