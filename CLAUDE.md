...
| `getStudentWatchRanking([range])` | `'7'` `'30'` `'term'` `'YYYY-MM'` · default `'30'` | **4 อันดับแยกตามอาการ** ลิสต์ละ ≤50 คน ขั้นต่ำ 2 วัน + `totals[]` `months[]` |
...
ค่าที่ไม่รู้จักตกกลับไป `'30'` ไม่ throw (มาจาก dropdown ฝั่ง client ไม่ควรพังทั้งหน้า)
