...
`uploadSarabunFile` (`functions/missing.js`) เคยเป็น stub ที่คืน `status: 'success'`
ทั้งที่ไม่ได้เก็บไฟล์เลย ฝั่ง client จึงขึ้น "สำเร็จ!" ให้ครูดู แล้วไฟล์หายไปเฉย ๆ
ไม่มีใครรู้ว่าแนบไม่ติดมาตลอด
