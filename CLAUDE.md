...
- ⚠️ **ตัวนับตารางสอนต้องนับเฉพาะคาบรายวิชาจริง** — ตัด `HR`, `-` และ `CLUB%` ออกให้ตรงกับ
  ...
  ตารางสอนสักคาบ · ตัด `'HR'` อย่างเดียวไม่พอ **`setAllHomeroomTeachers` ใส่แถวแนะแนว
  กับวิถีพุทธด้วยรหัส `'-'`** ให้ทุกห้องที่ตั้งครูที่ปรึกษา — เป็นบั๊กที่หลุดไปถึงโรงเรียนจริง
