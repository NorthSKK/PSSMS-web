...
/**
 * คลังตัวชี้วัด/ผลการเรียนรู้ — `{ subject_code: [ประเภท, [[รหัส, คำอธิบาย, ประเมิน], …]] }`
 *
 * มีเพื่อให้ปุ่ม "ดึงจากคลัง" ในหน้าตั้งค่าโครงสร้างวิชาใช้ได้จริงบนเดโม — เดิมคลังว่าง
 * คนที่กดเข้ามาดูจากเว็บขายจึงเห็นหน้าเปล่าและปุ่มนั้นขึ้น "ไม่พบตัวชี้วัดของวิชา …"
 *
 * ⚠️ รหัสวิชาต้องตรงกับ `SUBJECTS` ทุกตัว — คลังจับคู่ด้วย `subject_code` ตรง ๆ
 * พิมพ์ไม่ตรงเมื่อไหร่แถวนั้นมีอยู่ใน DB แต่ไม่มีทางถูกดึงมาใช้
 *
 * ⚠️ วิชาเพิ่มเติมใช้ **ผลการเรียนรู้เป็นเลขลำดับ** (`1` `2` `3`) ส่วนวิชาพื้นฐานใช้
 * **รหัสตัวชี้วัดตามหลักสูตร** (`ท 1.1 ม.1/1`) — คนละรูปกันจริง ๆ ในหลักสูตร
 * ถ้า seed ใช้รูปเดียวกันหมด บั๊กที่เกิดกับรหัสมีเว้นวรรค/มีทับ จะไม่โผล่ตอนกดเล่นบนเดโม
 */
const CURRICULUM = {
  'ท21101': ['พื้นฐาน', [
    ['ท 1.1 ม.1/1', 'อ่านออกเสียงบทร้อยแก้วและบทร้อยกรองได้ถูกต้องเหมาะสม', 'ระหว่างทาง'],
    ['ท 2.1 ม.1/2', 'เขียนสื่อสารด้วยถ้อยคำถูกต้องชัดเจนเหมาะสมกับระดับภาษา', 'ระหว่างทาง'],
    ['ท 5.1 ม.1/3', 'อธิบายคุณค่าของวรรณคดีและวรรณกรรมที่อ่าน', 'ปลายทาง'],
  ]],
  'ท22101': ['พื้นฐาน', [
    ['ท 1.1 ม.2/1', 'จับใจความสำคัญและรายละเอียดของเรื่องที่อ่าน', 'ระหว่างทาง'],
    ['ท 3.1 ม.2/2', 'พูดสรุปใจความสำคัญของเรื่องที่ฟังและดู', 'ระหว่างทาง'],
    ['ท 4.1 ม.2/3', 'วิเคราะห์โครงสร้างประโยคสามัญ ประโยครวม และประโยคซ้อน', 'ปลายทาง'],
  ]],
  'ท33101': ['พื้นฐาน', [
    ['ท 1.1 ม.6/1', 'วิเคราะห์และวิจารณ์เรื่องที่อ่านอย่างมีเหตุผล', 'ระหว่างทาง'],
    ['ท 2.1 ม.6/2', 'เขียนรายงานเชิงวิชาการและอ้างอิงแหล่งข้อมูลได้ถูกต้อง', 'ปลายทาง'],
    ['ท 5.1 ม.6/3', 'ประเมินคุณค่าวรรณคดีและนำไปประยุกต์ใช้ในชีวิตจริง', 'ปลายทาง'],
  ]],
  'ว21101': ['พื้นฐาน', [
    ['ว 1.2 ม.1/1', 'เปรียบเทียบรูปร่างและโครงสร้างของเซลล์พืชและเซลล์สัตว์', 'ระหว่างทาง'],
    ['ว 2.1 ม.1/2', 'อธิบายสมบัติของสารและจำแนกสารด้วยเกณฑ์ที่กำหนด', 'ระหว่างทาง'],
    ['ว 2.3 ม.1/3', 'อธิบายการถ่ายโอนความร้อนและนำไปใช้ประโยชน์', 'ปลายทาง'],
  ]],
  'ว22101': ['พื้นฐาน', [
    ['ว 1.2 ม.2/1', 'อธิบายโครงสร้างและหน้าที่ของระบบต่าง ๆ ในร่างกายมนุษย์', 'ระหว่างทาง'],
    ['ว 2.2 ม.2/2', 'ทดลองและอธิบายผลของแรงลัพธ์ที่กระทำต่อวัตถุ', 'ระหว่างทาง'],
    ['ว 2.3 ม.2/3', 'อธิบายการเกิดและการใช้ประโยชน์จากแสงและการมองเห็น', 'ปลายทาง'],
  ]],
  'ว31101': ['พื้นฐาน', [
    ['ว 2.1 ม.4/1', 'อธิบายโครงสร้างอะตอมและการจัดเรียงอิเล็กตรอน', 'ระหว่างทาง'],
    ['ว 2.2 ม.4/2', 'คำนวณและอธิบายการเคลื่อนที่แนวตรงของวัตถุ', 'ระหว่างทาง'],
    ['ว 2.3 ม.4/3', 'อธิบายการเปลี่ยนรูปพลังงานและการอนุรักษ์พลังงาน', 'ปลายทาง'],
  ]],
  'ว30201': ['เพิ่มเติม', [
    ['1', 'สืบค้นและอธิบายธรรมชาติของวิชาฟิสิกส์และการวัดปริมาณทางฟิสิกส์', 'ระหว่างทาง'],
    ['2', 'วัดและรายงานผลการวัดพร้อมระบุความไม่แน่นอนของการวัด', 'ระหว่างทาง'],
    ['3', 'ทดลองและอธิบายความสัมพันธ์ระหว่างตำแหน่ง ความเร็ว และความเร่ง', 'ปลายทาง'],
    ['4', 'วิเคราะห์และคำนวณการเคลื่อนที่แนวตรงด้วยความเร่งคงตัว', 'ปลายทาง'],
  ]],
  'ว30205': ['เพิ่มเติม', [
    ['1', 'อธิบายสมบัติของคลื่นกลและปรากฏการณ์ที่เกี่ยวข้อง', 'ระหว่างทาง'],
    ['2', 'ทดลองและอธิบายการสะท้อนและการหักเหของแสง', 'ระหว่างทาง'],
    ['3', 'วิเคราะห์วงจรไฟฟ้ากระแสตรงและคำนวณค่าที่เกี่ยวข้อง', 'ปลายทาง'],
  ]],
  'พ21101': ['พื้นฐาน', [
    ['พ 1.1 ม.1/1', 'อธิบายการเปลี่ยนแปลงทางร่างกายและจิตใจในวัยรุ่น', 'ระหว่างทาง'],
    ['พ 4.1 ม.1/2', 'เลือกรับประทานอาหารให้เหมาะสมกับวัยและกิจกรรมที่ทำ', 'ระหว่างทาง'],
    ['พ 5.1 ม.1/3', 'อธิบายวิธีหลีกเลี่ยงพฤติกรรมเสี่ยงต่อสุขภาพ', 'ปลายทาง'],
  ]],
  'พ22101': ['พื้นฐาน', [
    ['พ 2.1 ม.2/1', 'อธิบายการสร้างสัมพันธภาพที่ดีกับผู้อื่นในครอบครัวและโรงเรียน', 'ระหว่างทาง'],
    ['พ 4.1 ม.2/2', 'วางแผนดูแลสุขภาพของตนเองและคนในครอบครัว', 'ระหว่างทาง'],
    ['พ 5.1 ม.2/3', 'แสดงวิธีปฐมพยาบาลเบื้องต้นได้ถูกต้อง', 'ปลายทาง'],
  ]],
  'พ32101': ['พื้นฐาน', [
    ['พ 4.1 ม.5/1', 'วิเคราะห์ปัจจัยที่ส่งผลต่อสุขภาพและวางแผนพัฒนาสุขภาพตนเอง', 'ระหว่างทาง'],
    ['พ 5.1 ม.5/2', 'วิเคราะห์ผลกระทบของสารเสพติดต่อบุคคล ครอบครัว และสังคม', 'ปลายทาง'],
  ]],
  'พ33101': ['พื้นฐาน', [
    ['พ 4.1 ม.6/1', 'ประเมินภาวะสุขภาพของตนเองและปรับพฤติกรรมให้เหมาะสม', 'ระหว่างทาง'],
    ['พ 5.1 ม.6/2', 'เสนอแนวทางป้องกันอุบัติเหตุและความรุนแรงในชุมชน', 'ปลายทาง'],
  ]],
  'พ21103': ['พื้นฐาน', [
    ['พ 3.1 ม.1/1', 'เล่นกีฬาไทยและกีฬาสากลประเภทบุคคลได้อย่างน้อย 1 ชนิด', 'ระหว่างทาง'],
    ['พ 3.2 ม.1/2', 'ปฏิบัติตามกฎ กติกา และมีน้ำใจนักกีฬาในการแข่งขัน', 'ปลายทาง'],
  ]],
  'พ22103': ['พื้นฐาน', [
    ['พ 3.1 ม.2/1', 'เล่นกีฬาประเภททีมได้อย่างน้อย 1 ชนิดและอธิบายหลักการเล่น', 'ระหว่างทาง'],
    ['พ 3.2 ม.2/2', 'ร่วมกิจกรรมออกกำลังกายอย่างสม่ำเสมอและประเมินสมรรถภาพตนเอง', 'ปลายทาง'],
  ]],
  'พ32103': ['พื้นฐาน', [
    ['พ 3.1 ม.5/1', 'เล่นกีฬาที่เลือกได้อย่างชำนาญและใช้กลวิธีในการแข่งขัน', 'ระหว่างทาง'],
    ['พ 3.2 ม.5/2', 'วางแผนพัฒนาสมรรถภาพทางกายของตนเองอย่างเป็นระบบ', 'ปลายทาง'],
  ]],
  'พ33103': ['พื้นฐาน', [
    ['พ 3.1 ม.6/1', 'แสดงทักษะกีฬาที่เลือกในระดับที่นำไปแข่งขันได้', 'ระหว่างทาง'],
    ['พ 3.2 ม.6/2', 'เป็นผู้นำจัดกิจกรรมออกกำลังกายให้กับกลุ่มเพื่อน', 'ปลายทาง'],
  ]],
};
...
async function fill({ term, year, teacherNames, schoolName }) {
  ...
  // ---------------------------------------------------------------- คลังตัวชี้วัด
  // ⚠️ ล้างเฉพาะรหัสวิชาของเดโม ไม่ใช่ทั้งตาราง — `curriculum` ไม่มีคอลัมน์เทอม/ปี
  // เป็นคลังกลางที่สะสมข้ามปี ล้างทิ้งทั้งก้อนทุกคืนคือลบของที่คนกรอกเพิ่มไว้เอง
  const curCodes = Object.keys(CURRICULUM);
  await query(`DELETE FROM curriculum WHERE subject_code = ANY($1)`, [curCodes]);
  let curRows = 0;
  for (const code of curCodes) {
    const [type, items] = CURRICULUM[code];
    for (const [std, desc, evalType] of items) {
      await query(
        ...
        [code, type, std, desc, evalType]
      );
      curRows++;
    }
  }
  log.push(`คลังตัวชี้วัด ${curRows} รายการ (${curCodes.length} วิชา)`);
