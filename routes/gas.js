...
const MANAGEMENT_ONLY = new Set([
  ...
  'getSetupChecklist',
  'addCurriculumItem', 'updateCurriculumItem', 'deleteCurriculumItem', 'getCurriculumCount',
  'setupCalendarDatabase', 'setupClubDatabase',
...
const READONLY_ALLOWED = new Set([
    ...
    'getStudentDashboardBundle', 'getStudentWeeklyTimetable', 'getStudentAcademicSummary',
    'getStudentSummaryStats', 'getStudentsByClass',
...
const handlers = {
  ...
  getStudentWeeklyTimetable:       (args, user) => missing.getStudentWeeklyTimetable(args, user),
  getStudentAcademicSummary:       (args, user) => missing.getStudentAcademicSummary(args, user),
  ...
  getCurriculumCount:              () => missing.getCurriculumCount(),
