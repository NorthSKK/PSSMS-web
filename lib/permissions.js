 ...
 *
 * ใช้กับของที่เป็นงานของบุคลากรทั้งหมดแต่ไม่ใช่ของแอดมินคนเดียว เช่นการ **อ่าน**
 * ทะเบียนสารบรรณ · ⚠️ เดิมใช้ `teacherOrAdmin` ซึ่งกัน Executive ออกไปด้วย
 * ทั้งที่เมนูของ ผอ. มีหน้างานสารบรรณอยู่ กดแล้วเจอ "สงวนสิทธิ์เฉพาะครูหรือผู้ดูแลระบบ"
 * (การเขียนยังเป็น `teacherOrAdmin` เหมือนเดิม — ผอ. อ่านได้อย่างเดียวตาม ADR 0001)
 */
